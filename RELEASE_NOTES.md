...
- ci(merge): configure git identity for tagging and guard against existing remote tag (673df73)### Chore
...
- chore(hotfix): maintenance updates (snapshot changelog, Unreleased notes, lockfile) [skip ci] (4fb6a72)### Docs
...
- PR #82: Hotfix/fix merge (f9356ba)Generated by git-cliff.
