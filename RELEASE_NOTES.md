...
- chore(ci): allow hotfix branches without semver to update notes/changelog/lockfile (dfd3e4b)### Docs
...
- fix(ci): use local reusable workflow paths so release runs at the same commit (ed1c4aa)### Other
...
- PR #80: Release/0.2.8 (8572b99)Generated by git-cliff.
